...
| PG | task | #19(007完了)・#21(001完了)・#23(002完了)・#25(003完了) | front-intra-001〜007 | frontend | feature/costman-2026-001-pg-front-intra-###-sp-002 | 手戻りsp-002対応として着手（2026-08-24）。front-intra-007（issue #19・PR #20）・front-intra-001（issue #21・PR #22）・front-intra-002（issue #23・PR #24）・front-intra-003（issue #25・PR #26）完了・レビュー待ち。いずれも`/reacter-code-gen`→`/reacter-code-review`（観点台帳クラスタ別2パス検証）を実施。front-intra-007: `HANDLING_STATUS_CODE`への403追加。front-intra-001: 型定義切り出し・try-catch追加・as const付与。front-intra-002: レイアウトCSS修正（CSS-04）。front-intra-003: コード修正不要（既存実装が設計と完全一致）。全機能ID横断の既存課題（COM-01・QLT-22）はADR-PG-1.mdにバックログ化。front-intra-002・003ではUI工程正本（docs/base-design/）のSS修正未追従も検出しmeta.mdバックログ持ち越し管理表No.1〜6に記録。残り3機能ID（004〜006）へ展開中。事後修正: PR #11（`.env.development`/`.env.prod`のセッションタイムアウト設定値を仕様〔1時間・タイムアウト30秒前警告〕に修正、マージ済み2026-08-24） |
